...
```{r aed-u01, echo=FALSE, fig.cap="\\label{fig:u01}U-01 · Distribution annuelle des observations (2010–2023). Tendance décroissante nette à partir de 2016.", out.width="10cm", fig.align="center"}
...
```{r aed-u04, echo=FALSE, fig.cap="\\label{fig:u04}U-04 · Représentation des trois phylums (N total = 459 773).", out.width="8cm", fig.align="center"}
...
```{r aed-u02, echo=FALSE, fig.cap="\\label{fig:u02}U-02 · Répartition des observations par classe de proximité aux ports (1 = plus éloigné, 10 = plus proche).", out.width="10cm", fig.align="center"}
...
```{r aed-b01, echo=FALSE, fig.cap="\\label{fig:b01}B-01 · Distance moyenne au port par phylum (barres d'erreur = ± écart-type).", out.width="9cm", fig.align="center"}
...
```{r aed-q2, echo=FALSE, fig.cap="\\label{fig:q2}Comparaison du ratio de diversité spécifique (espèces distinctes / observations) selon la proximité aux ports (A) et aux infrastructures offshore (B).", out.width="10cm", fig.align="center"}
...
```{r aed-q5, echo=FALSE, fig.cap="\\label{fig:q5}Q-05 · Profil bathymétrique moyen par classe de distance au port (ruban = ± écart-type).", out.width="10cm", fig.align="center"}
...
```{r aed-b07, echo=FALSE, fig.cap="\\label{fig:b07}B-07 · Relation entre log(distance port) et log(distance infra) par phylum, avec coefficients de Spearman.", out.width="11cm", fig.align="center"}
...
```{r aed-q4, echo=FALSE, fig.cap="\\label{fig:q4}Q-04 · Distance moyenne au port par phylum et par année (2010–2023), panneau A : Arthropoda vs Chordata, panneau B : Arthropoda vs Cnidaria.", out.width="11cm", fig.align="center"}
...
```{r aed-infra, echo=FALSE, fig.cap="\\label{fig:infra}Nombre d'observations associées par type d'infrastructure offshore.", out.width="10cm", fig.align="center"}
...
```{r inf-kruskal, echo=FALSE, fig.cap="\\label{fig:kruskal}T-01 · Résultats du test de Kruskal-Wallis et comparaisons post-hoc (test de Dunn, correction de Bonferroni) pour la distance au port selon le phylum.", out.width="10cm", fig.align="center"}
...
```{r inf-regression, echo=FALSE, fig.cap="\\label{fig:reg}T-02 · Droites de régression log-log par phylum (distance port ~ distance infra).", out.width="10cm", fig.align="center"}
