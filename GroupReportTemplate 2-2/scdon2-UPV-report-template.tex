...
réel de la biodiversité : elle reflète plutot une réduction de de
collecte et/ou de soumission des données dans la base GBIF sur la
période récente.
...
confondues » pourraient etre considerer comme des statistiques
Arthropoda.
...
marins sont observés dans des zones plus éloignées des infrastructures
portuaires, alors que les cnidaires et les chordés se concentrent dans
des zones côtières.
...
classe 1 (0,41 \%, soit 1 857 espèces pour 448 375 observations) du au
nombre d'observation bien plus important qui conduit a une diversité
plus petite malgré le nombre d'espece differentes plus important que
ailleurs, puis remonte fortement dès la classe 2 (9,2 \%) et atteint un
pic en classe 8 (21,9 \%). La classe 9 présente une anomalie (1,0 \%
