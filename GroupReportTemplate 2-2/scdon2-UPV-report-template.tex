...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.0843}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3855}}
  >{\centering\arraybackslash}p{(\linewidth - 6\tabcolsep) * \real{0.3735}}@{}}
...
\bottomrule\noalign{}
\endlastfoot
id\_espece & Texte & Identifiant unique de l'espece & Clé primaire,
unique, non nul \\
\end{longtable}
