...
\title{Projet réalisé par\\[0.5cm] l'équipe XXX du groupe de TD1 ou
TD2 \\[3cm]Rapport de groupe des UE \newline  Bases de données +
...
Une bonne introduction débute par une présentation du contexte, avant de
définir votre ou vos questions de recherche. Il peut être bon d'afficher
votre question de recherche en gras, séparée du reste du texte, comme
ceci:
...
Vous devez décrire les principaux rôles de chaque membre du groupe dans
l'équipe.
...
volée (R Core Team 2017 ; Lafaye de Micheaux, Drouilhet, Liquet 2013).
Vous pouvez inclure des commandes \LaTeX.
...
Pour commencer, vous listerez les variables étudiées et préciserez leur
nature.

Ensuite, il faut produire de nombreux résumés graphiques (\emph{e.g.},
...
\hypertarget{infuxe9rence-statistique-et-moduxe9lisation}{%
...
\hypertarget{la-droite-de-ruxe9gression-linuxe9aire-un-premier-exemple}{%
...
LAFAYE DE MICHEAUX, P., DROUILHET, R. et LIQUET, B., 2013. \emph{The {R}
Software: Fundamentals of Programming and Statistical Analysis}
{[}en~ligne{]}. Springer New York. Statistics et Computing.
ISBN~9781461490203. Disponible à l\textquotesingle adresse~:
\url{https://books.google.fr/books?id=Ji-8BAAAQBAJ}

\leavevmode\vadjust pre{\hypertarget{ref-R}{}}%
R CORE TEAM, 2017. \emph{{R}: A Language and Environment for Statistical
Computing} {[}en~ligne{]}. Vienna, Austria~: R Foundation for
Statistical Computing. Disponible à l\textquotesingle adresse~:
