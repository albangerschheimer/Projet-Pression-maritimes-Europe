...
Sciences des données 2. \medskip Le cadre du projet demande justement
d'utiliser plusieurs sources réelles, de les intégrer dans une base
relationnelle, puis de les interroger pour produire des tableaux et
analyses. \medskip Nous avons retenu ces jeux de données car ils
permettent de croiser une information biologique, à savoir les
occurrences d'espèces marines, avec des informations spatiales décrivant
certaines pressions anthropiques. Ce croisement est cohérent avec notre
problématique, qui porte sur l'influence potentielle des ports et des
infrastructures offshore sur la distribution observée de la biodiversité
marine.
...
Les critères appliqué sont les suivants : - zone :
\textbf{Europe maritime} - période : \textbf{2010–2026} - espèces :
\textbf{uniquement 3 grands groupes} - observations :
\textbf{présentes uniquement} - coordonnées : \textbf{obligatoires} -
problèmes spatiaux :
\textbf{on exclut les observations avec souci géospatial} - profondeur :
\textbf{plus petit ou égal à 0 pour garder que les espèces maritimes.}
