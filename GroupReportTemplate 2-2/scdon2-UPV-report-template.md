...
\textbf{Alban Gerschheimer} & Étudiant numéro XXXX, Resp. de l'import de données et des requêtes SQL.\\
\textbf{Omar Terras} & Étudiant numéro XXXX, Resp.\\
\textbf{Alfred Gyalay} & Étudiant numéro XXXX, Resp. du code R.\\
...
On crée alors une liaison entre les 2 en ajoutant le port le plus proche et en liant les colonnes en FK.
...
Les requêtes complémentaires sur les espèces les plus observées et l’évolution annuelle ont été placées en fin de rapport : [Requêtes complémentaires en ANNEXE](#annexe-requetes-complementaires).
...
Les requêtes sur les observations situées sous la distance moyenne et les phylums abondants proches des ports sont aussi disponibles en annexe : [Requêtes complémentaires en ANNEXE](#annexe-requetes-complementaires).
